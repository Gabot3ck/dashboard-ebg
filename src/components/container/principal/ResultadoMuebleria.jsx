...
export const ResultadoMuebleria = () => {
    ...
    return (<>
        <div className='container bg-light w-100'>
            ...
            <h1 className='text-center' >Resultados Mueblería</h1>
            ...
            <div className='w-100 mx-auto my-5 d-flex flex-column text-center ' style={{background: "#d1d2d1"}} >
                ...
                <div className='w-50 mx-auto my-5 d-flex flex-column align-items-center'>
                    <GraficoDonutTipoGastos tipoArea="Muebleria"/>
                    <GraficoBarraConceptoGastos tipoArea="Muebleria"/>
                    <GraficoBarraDobleVentasGastos tipoArea="Muebleria"/>
                </div>
