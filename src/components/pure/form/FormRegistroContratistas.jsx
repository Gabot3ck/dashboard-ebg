...
export default function FormRegistroContratistas({setData}) {
...
{/* //todo       ****  Datos  para la Transferencia  **** */}
            ...
            <div className="col-md-12">
                ...
                <input
                    ...
                    type="text" 
                    className="form-control" 
                    id="nombreTransferenciaContratista" 
            ...
            <div className="col-md-4">
                ...
                <input
                    ...
                    type="text" 
                    className="form-control" 
                    id="bancoTransferenciaContratista" 
...
{/* //?       ****  Datos  de  ubicación  **** */}
            ...
            <div className="col-md-6">
                ...
                <input
                    ...
                    type="text" 
                    className="form-control" 
                    id="apellidoContactoContratista"
